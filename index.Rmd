...
The single regression tree predicted 48% of the outcomes correctly and the gbm boosted model predicted 98% correct outcomes.  the Random Forest model proved to be the most accurate with 99% of the outcomes correctly predicted.
...
# min_depth_frame <- min_depth_distribution(modFit)
